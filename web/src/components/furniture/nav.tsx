...
export default component$(() => {
  ...
  const themes = [
    ...
    const deleteAllData = $(() => {
    const isConfirmed = confirm('Tüm yerel verileri silmek istediğinizden emin misiniz? Bu, ilerlemenizi silecektir.');
    if (isConfirmed) {
      localStorage.clear();
      location.reload();
    }
    ...
    <>
        ...
        <div class="flex-none hidden md:flex">
          <ul class="menu menu-horizontal px-1">
            ...
            <li>
              <a href="https://github.com/lissy93/personal-security-checklist"
                class="tooltip flex tooltip-bottom" data-tip="Kaynağı ve Veriyi Görüntüle / Düzenle">
                <Icon icon="github" width={16} height={16}  />GitHub
              </a>
            </li>
          </ul>
          <div class="tooltip tooltip-bottom" data-tip="Tema">
          ...
          <li class="list-none px-2">
            <p
              ...
              class="cursor-pointer tooltip flex tooltip-bottom" data-tip="Ayarlar">
      ...
      <div class="drawer-side z-10">
        ...
        <ul class="rounded-box menu p-4 w-80 min-h-full bg-base-200">
          ...
          <li>
            <a href="https://digital-defense.io/about/">
              <Icon class="mr-2" icon="about" width={16} height={16} />Hakkında
            </a>
            <ul>
              <li>
                <a href="https://github.com/Lissy93/personal-security-checklist/?tab=readme-ov-file#contributing">Katkıda Bulunma</a>
              </li>
              <li>
                <a href="https://github.com/Lissy93/personal-security-checklist/blob/master/LICENSE">Lisans</a>
              </li>
            </ul>
            <ul>
            <li>
              <a href="https://digital-defense.io/about/#author">Yazar</a>
              <ul>
                <li><a href="https://aliciasykes.com/contact">İletişim</a></li>
                <li>
                  <a href="https://apps.aliciasykes.com">Diğer Uygulamalar</a>
                </li>
      ...
      <dialog id="settings_modal" class="modal">
        <div class="modal-box">
          <div class="tabs tabs-lifted">
            <p class="tab tab-active">Ayarlar</p>
            <a class="tab" href="https://digital-defense.io/about/">Hakkında</a>
          </div>
          <div class="modal-action justify-start w-full flex flex-col gap-4">
              ...
              <div class="flex items-between w-full justify-between">
                <label class="label">Veri</label>
                <button class="btn btn-primary" onClick$={deleteAllData}>Tümünü Sil</button>
              </div>
              <button
